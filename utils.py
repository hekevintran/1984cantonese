...
def replaceVariants():
	...
	#But 象 > 𧰼
	"像":"像", "斯滅":"斯密", "㦸":"戟", "批蕩":"批盪", "模仿":"模倣", "傚仿|效倣|效仿":"傚倣", "逗留":"逗遛", "朵":"朶", "棵":"樖", "床":"牀", "黄":"黃", "部分":"部份", "屏":"屛", "偋":"𠌸", "清":"淸", "青":"靑", "麵":"麪", "雕":"彫", "游行":"遊行", "巡游":"巡遊", "逼近":"迫近", "螺母":"螺帽", "墻":"牆", "部分":"部份", "犁":"犂", "了解":"瞭解", "牛豆|怐豆":"牛鬥", "(煅煉|鍛煉|煅鍊)":"鍛鍊", "花崗靑":"花剛巖", "撴":"撉", "下巴":"下爬", "嗍":"欶", "掰":"擘", "等於|等如":"等于", "研":"硏", "令":"令","零":"零","慎":"愼","說":"說","𥊙":"䁓","啱|懨":"懕","([^自])己":"\g<1>个","滯":"懠","([我你佢人])地":"\g<1>敵", "搣":"扒", "邋塌":"邋塌", "邋邋塌塌":"邋邋遢遢", "同埋":"同彌", "屋[企徛]":"屋其","裏面":"裏邊", "醒起":"省起", "搏命":"博命", "滾":"滚", "剷":"鏟", "挽":"輓", "須要":"需要", "繼承":"承繼",
	#︐︑︒︓︔︕︖﹃﹄﹁﹂︵︶︽︾︙︱
	"「":"﹁","」":"﹂","『":"﹃","』":"﹄","，":"︐","、":"︑","。":"︒",
"：":"︓","；":"︔","！":"︕","？":"︖","（":"︵","）":"︶","《":"︽",
"》":"︾","—":"︱","…":"︙"," · ":"・",
